...
const client = new Client({
  phoneNumber: '9647831000007', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "VA", lid: "9647831000007@lid", jid: "201280912182@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "9647831000007@lid", jid: "201280912182@s.whatsapp.net" },
  // Owner 3
    { name: "Sukuna", jid: "9647831000007@s.whatsapp.net", lid: "50414477168824@lid" },
  // Owner 4 
